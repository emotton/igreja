...
router.post('/', logged, (req, res) => {
    ...
    let prefsObj = {
        'produtos': req.body['pref-produto'] instanceof Array ? req.body['pref-produto'] : [req.body['pref-produto']],
        'carteiras': req.body['pref-carteira'] instanceof Array ? req.body['pref-carteira'] : [req.body['pref-carteira']],
        'linhas': req.body['pref-linha'] instanceof Array ? req.body['pref-linha'] : [req.body['pref-linha']]
    };
